...
#define ZMK_HID_RPC_REPORT_COUNT_USB (CONFIG_HID_INTERRUPT_EP_MPS - 1)
#endif // IS_ENABLED(CONFIG_ZMK_USB)
#if IS_ENABLED(CONFIG_ZMK_BLE)
#define ZMK_HID_RPC_REPORT_COUNT_BLE (15)
#endif // IS_ENABLED(CONFIG_ZMK_BLE)
#if IS_ENABLED(CONFIG_ZMK_USB) && IS_ENABLED(CONFIG_ZMK_BLE)
#define ZMK_HID_RPC_REPORT_COUNT MIN(ZMK_HID_RPC_REPORT_COUNT_USB, ZMK_HID_RPC_REPORT_COUNT_BLE)
#elif IS_ENABLED(CONFIG_ZMK_USB)
#define ZMK_HID_RPC_REPORT_COUNT ZMK_HID_RPC_REPORT_COUNT_USB
#elif IS_ENABLED(CONFIG_ZMK_BLE)
#define ZMK_HID_RPC_REPORT_COUNT ZMK_HID_RPC_REPORT_COUNT_BLE
#endif // IS_ENABLED(CONFIG_ZMK_USB) && IS_ENABLED(CONFIG_ZMK_BLE)
